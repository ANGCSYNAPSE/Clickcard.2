  ...
  return (
    <div className="bg-white dark:bg-dark-hover rounded-2xl p-6 border border-line/50 dark:border-line/10">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-bold text-ink dark:text-white">User Growth</h3>
      ...
      <div className="h-64 bg-gradient-to-b from-secondary/10 to-secondary/5 rounded-lg flex items-center justify-center">
        <p className="text-muted dark:text-white/60">User growth chart data</p>
      </div>
    </div>
  );
}
