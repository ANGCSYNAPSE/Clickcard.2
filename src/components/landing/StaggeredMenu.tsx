...
export const StaggeredMenu = ({
  ...
  // The closed panel is only moved offscreen, so its links stay in the tab
  // order — `aria-hidden` alone would leave a focusable region that screen
  // readers are told to ignore. `inert` takes it out of both.
  React.useEffect(() => {
    const panel = panelRef.current;
    if (!panel) return;
